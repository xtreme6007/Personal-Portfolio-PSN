        ...
        <Container className="ProjectContainer">
            ...
            <Col>
                ...
                <ProjectCard
                    ...
                    title={"Rando-Raunt"}
                    description={"My girlfreind and I often see restraunts around the DFW area that we just simply never knew about. So I built an application to help decide on something new."}
