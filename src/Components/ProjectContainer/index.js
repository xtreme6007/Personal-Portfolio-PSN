        ...
        <Container className="ProjectContainer">
            ...
            <Col>
                ...
                <ProjectCard
                    ...
                    title={"Rando-Raunt"}
                    description={"My girlfriend and I often see restaurants around the DFW area that we just simply never knew about, so I built an application to help decide on something new."}
